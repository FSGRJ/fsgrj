...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://linkedin.com/in/fabiano-sampaio-gonçalves-93082128)
...
[![Location](https://img.shields.io/badge/Rio%20de%20Janeiro%2C%20Brasil-009C3B?style=for-the-badge&logo=googlemaps&logoColor=white)](#)
...
Analista de Sistemas com mais de **10 anos de experiência** em criação e implementação de soluções tecnológicas para **instituições financeiras e corporativos de grande porte**. Especialista em melhoria de processos, integração de sistemas e pipelines de entrega contínua, com foco em eficiência operacional, redução de falhas e segurança de dados.

Atualmente expandindo minha atuação em **Cloud Computing** e **DevOps**, com ênfase em Azure, automação de infraestrutura e práticas modernas de engenharia de software.

- 🔭 Trabalhando com **Azure DevOps · CI/CD Pipelines · IaC**
- 🌱 Aprofundando conhecimento em **Kubernetes · GitOps · Observabilidade**
- 🤝 Aberto a colaborações em **projetos open source de DevOps e Cloud**
...
| Certificação | Emissor |
|---|---|
| Automation Developer Professional | UiPath Academy |
...
<div align="center">
  <img src="https://komarev.com/ghpvc/?username=FSGRJ&style=for-the-badge&color=58A6FF&label=VISUALIZAÇÕES+DO+PERFIL" alt="Profile views" />
</div>
